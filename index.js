...
const generateValue = (angleValue) => {
  for (let i of spinValues) {
    if (angleValue >= i.minDegree && angleValue <= i.maxDegree) {
      if (spinBtn.disabled) {
        text.innerHTML = `<p>Congratulations, You Have Won $${i.value} Gift Card! Enjoy</p>`;
        spinBtn.innerHTML = "Try Again";
      } else {
        text.innerHTML = "<p>Spin The Wheel</p>";
      }
      break;
    }
  }
...
spinBtn.addEventListener("click", generateSpin);
